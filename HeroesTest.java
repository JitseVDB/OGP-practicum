...
public class HeroesTest {
    ...
    void testInitialCapacityIsZero() {
        Hero hero = new Hero("Guillaume", 100, 10);
        assertEquals(0, hero.getCapacity());
    }

    @Test
    void testGetMaxCapacityCalculation() {
        Hero hero = new Hero("Guillaume", 100, 10);
        assertEquals(200, hero.getMaxCapacity()); // 10*20kg

        hero.multiplyStrength(2);
        assertEquals(400, hero.getMaxCapacity());
    }

    @Test
    void testAddCapacityWithinLimit() {
        Hero hero = new Hero("Guillaume", 100, 10); // max = 200
        hero.addCapacity(50);
        assertEquals(50, hero.getCapacity());

        hero.addCapacity(100);
        assertEquals(150, hero.getCapacity());
    }

    @Test
    void testAddCapacityOverLimitIsIgnored() {
        Hero hero = new Hero("Guillaume", 100, 10); // max = 200
        hero.addCapacity(190);
        assertEquals(190, hero.getCapacity());

        hero.addCapacity(20); // zou 210 worden → overschrijdt max → genegeerd
        assertEquals(190, hero.getCapacity());
    }

    @Test
    void testAddCapacityWithZeroOrNegativeIgnored() {
        Hero hero = new Hero("Guillaume", 100, 10);
        hero.addCapacity(0);
        hero.addCapacity(-10);
        assertEquals(0, hero.getCapacity());
    ...
    @Test
    void testRemoveCapacityWithinRange() {
        Hero hero = new Hero("Guillaume", 100, 10);
        hero.addCapacity(100);
        hero.removeCapacity(40);
        assertEquals(60, hero.getCapacity());
    }

    @Test
    void testRemoveCapacityBelowZeroIsIgnored() {
        Hero hero = new Hero("Guillaume", 100, 10);
        hero.addCapacity(30);
        hero.removeCapacity(40); // zou negatief worden → genegeerd
        assertEquals(30, hero.getCapacity());
    }

    @Test
    void testRemoveCapacityToZeroIsIgnored() {
        Hero hero = new Hero("Guillaume", 100, 10);
        hero.addCapacity(30);
        hero.removeCapacity(30);
        assertEquals(30, hero.getCapacity());
    }

    @Test
    void testRemoveCapacityWithZeroOrNegativeIgnored() {
        Hero hero = new Hero("Guillaume", 100, 10);
        hero.addCapacity(50);
        hero.removeCapacity(0);
        hero.removeCapacity(-5);
        assertEquals(50, hero.getCapacity());
    }
